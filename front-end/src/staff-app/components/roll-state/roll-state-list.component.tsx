...
interface Props {
  stateList: StateList[]
  filterByRollState?: (type: ItemType) => void
  size?: number
}
export const RollStateList: React.FC<Props> = ({ stateList, size = 14, filterByRollState }) => {
  const onClick = (type: ItemType) => {
    if (filterByRollState) {
      filterByRollState(type)
    }
  }
